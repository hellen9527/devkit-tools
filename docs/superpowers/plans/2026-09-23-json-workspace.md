...
- [ ] Run unit/build/browser checks, independent review, then publish through existing Git→Cloudflare deployment. Confirm production artifacts and save checkpoint.
